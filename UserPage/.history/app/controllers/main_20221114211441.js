...
const renderCartTable = () => {
    ...
    if (arrCart) {
        arrCart.map(cartItem => {
            console.log('PhongT hanh 🚀 ~> cartItem', cartItem)
            content = `
            <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-3">
                <div class="text-center">${cartItem.phone.img}</div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                <div class="text-center">${cartItem.phone.price}</div>
            </div>
        </div>
            `
        })
    }
    document.getEl('prCart').innerHTML = content
}

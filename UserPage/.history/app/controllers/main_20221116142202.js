...
const renderCartTable = () => {
    ...
    if (content == '') {
      ...
      <div class="btnfooterCart">
        ...
        <button class="btnSecondary"> <span><i class="fa-solid fa-credit-card"></i></ span> Purchase
        </button>
      </div>
      `;
    }
...
const clearAllCart = () => {
    Swal.fire({
            ...
            imageUrl: ' https: //www.pngfind.com/pngs/m/272-2727925_continue-shopping-empty-cart-png-transparent-png.png',
            imageWidth: 400,
            imageHeight: 200,

...
const seeProductCart = id => {
    ...
    ProductList.getProduct(id)
        .then(result => {
            ...
            <div class="col-6 infoPhone__img">
                <img src="${result.data.img}" style="width:100%" alt="">
            </div>
            <div class="col-6 infoPhone__desc ">
                <h3 class="infoPhone__name text-center pb-3">${result.data.name}</h3>
    ...
    // console.log('PhongThanh 🚀 ~> prSee', prSee)

    // getEl('infoPhone__content').innerHTML = `
    // <div class="col-6 infoPhone__img">
    //     <img src="${prSee.img}" style="width:100%" alt="">
    // </div>
    // <div class="col-6 infoPhone__desc ">
    //     <h3 class="infoPhone__name text-center pb-3">${prSee.name}</h3>
    //     <div class="infoPhone__desc__text infoPhone__price">
    //     <span>Price:</span> <b>$${prSee.price}</b>
    //     </div>
    //     <div class="infoPhone__desc__text infoPhone__screen">
    //     <span>Screen: </span> <b>${prSee.screen}</b>
    //     </div>
    //     <div class="infoPhone__desc__text infoPhone__backCam">
    //     <span>BackCamera:</span> <b>${prSee.backCamera}</b>
    //     </div>
    //     <div class="infoPhone__desc__text infoPhone__frondCam">
    //     <span> FrontCamera:</span> <b>${prSee.frontCamera}</b>
    //     </div>
    //     <div class="infoPhone__desc__text infoPhone__descChild">
    //     <span>Desc:</span> <b>${prSee.desc}</b>
    //     </div>
    //     <div class="infoPhone__desc__text infoPhone__type">
    //         <span>Type:</span> <b>${prSee.type}</b>
    //     </div>
    // </div>
    // `
}

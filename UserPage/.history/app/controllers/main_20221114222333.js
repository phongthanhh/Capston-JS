...
const renderCartTable = () => {
    let content = '';
    if (arrCart) {
        console.log('PhongThanh 🚀 ~> arrCart', arrCart)
    ...
    // <img src=" https://bizweb.dktcdn.net/100/031/831/themes/740933/assets/empty-cart.png?1623312998512"alt=""/>

    if (content == '') {
        getEl('headerCart').style.display = 'none'
        getEl('prCart').innerHTML = `<div>
    
        </div>`
    } else {
        console.log('có contetn')
    }

...
const renderCartTable = () => {
    ...
    if (content == '') {
      ...
      <button class="btnSecondary mr-3" onclick='clearAllCart()' > <span><i class="fa-solid fa-trash"></i></span> Clear Cart</button>
  <button class="btnSecondary"> <span><i class="fa-solid fa-credit-card"></i></ span> Purchase</button>
    </div>
      `;
    }

...
const seeProductCart = id => {
    ...
    ProductList.getProduct(id)
        .then(result => {
            console.log(result.data)
            getEl('infoPhone__content').innerHTML = `
            <div class="col-12 col-lg-6 infoPhone__img">
                <img src="${result.data.img}" style="width:100%" alt="">
            </div>
            <div class="col-12 col-lg-6 infoPhone__desc ">
                <h3 class="infoPhone__name text-center pb-xl-3">${result.data.name}</h3>
                <div class="infoPhone__desc__text infoPhone__price">
                <span>Price:</span> <b>$${result.data.price}</b>
                </div>
                <div class="infoPhone__desc__text infoPhone__screen">
                <span>Screen: </span> <b>${result.data.screen}</b>
                </div>
                <div class="infoPhone__desc__text infoPhone__backCam">
                <span>BackCamera:</span> <b>${result.data.backCamera}</b>
                </div>
                <div class="infoPhone__desc__text infoPhone__frondCam">
                <span> FrontCamera:</span> <b>${result.data.frontCamera}</b>
                </div>
                <div class="infoPhone__desc__text infoPhone__descChild">
                <span>Desc:</span> <b>${result.data.desc}</b>
                </div>
                <div class="infoPhone__desc__text infoPhone__type">
                    <span>Type:</span> <b>${result.data.type}</b>
                </div>
            </div>
            `
        })
...
const renderCartTable = () => {
            ...
            <div class="row align-items-center">
                <div class="col-2 col-sm-1">
                    <div class="text-center"> 
                        <button class="btn btn-danger" onclick='delCartItem(${index})'>
                            <i class="fa-solid fa-trash"></i>
                        </button>
                    </div>
                </div>
                <div class="modalCartImg col-sm-3">
                    <div class="text-center">
                ...
                <div class="col-4 col-sm-3">
                    ...
                    <span class='subQuantity'>
                        <button class='btnQuantity mr-1 mr-sm-2' onclick='subQuantity(${index})' ><i class="fa-solid fa-minus"></i></button>
                    </span>
                    ${cartItem.quantity}
                    <span class='plusQuantity'>
                    <button class='btnQuantity ml-1 ml-sm-2' onclick='plusQuantity(${index})' >
    ...
    if (content == '') {
        ...
        content = `
        <img src=" https://bizweb.dktcdn.net/100/031/831/themes/740933/assets/empty-cart.png?1623312998512" style="text-align:center; width:100%" alt=""/>
        `
